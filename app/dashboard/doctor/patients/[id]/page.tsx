...
import AddHealthRecordSection from '@/components/AddHealthRecordSection'

export default async function DoctorPatientDetailPage({ params }: { params: Promise<{ id: string }> | { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <nav className="bg-white border-b border-slate-200 shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <Link href="/dashboard/doctor/patients" className="text-sm text-slate-600 hover:text-slate-900">
              ← Back to Patients
            </Link>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-6">
          <div className="flex justify-between items-start">
            ...
            <div className="text-right">
              ...
              <p className="text-xs font-mono text-slate-400 mb-3">{patient.id.slice(0, 8)}...</p>
              <Link href={`/dashboard/doctor/patients/${patientId}/reports`}>
        ...
        <AddHealthRecordSection patientId={patientId} />
        ...
        {healthRecords && healthRecords.length > 0 ? (
          ...
          <Card>
            <div className="text-center py-12">
              ...
              <p className="text-slate-600">Add a health record using the form above to get started</p>
            </div>
          </Card>
        )}
      </div>
